...
class _COCOMeta(object):
    INSTANCE_TO_BASEDIR = {
        ...
        'train_pos': cfg.DATA.IMGDIR,
        'train_neg': cfg.DATA.IMGDIR,
    }
...
class COCODetection(object):
    ...
    def _add_detection_gt(self, img, add_mask):
        ...
        for obj in objs:
            ...
            # if obj['area'] >= 1 and box.is_box() and box.area() >= 1:
        ...
        try:
            ...
            cls = np.asarray([0] * len(valid_objs))
...
if __name__ == '__main__':
    c = COCODetection(cfg.DATA.BASEDIR, 'train_neg_18425')
