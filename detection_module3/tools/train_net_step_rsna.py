...
def main():
    ...
    if args.dataset == "rsna2018_pos_neg":
        cfg.TRAIN.DATASETS = ('rsna2018_train_pos', 'rsna2018_train_neg', )
        cfg.TEST.DATASETS = ('rsna2018_val_pos', 'rsna2018_val_neg')
        cfg.MODEL.NUM_CLASSES = 2
    elif args.dataset == "rsna2018_pos":
        cfg.TRAIN.DATASETS = ('rsna2018_train_pos',)
        cfg.TEST.DATASETS = ('rsna2018_val_pos',)
        cfg.MODEL.NUM_CLASSES = 2
    ...
    try:
        ...
        for step in range(args.start_step, cfg.SOLVER.MAX_ITER):
            ...
            if (step + 1) % CHECKPOINT_PERIOD == 0:
                perforamce = eval_net(model=maskRCNN, submit_threshold=0.4, dataset_names=cfg.TEST.DATASETS,
                                      output_dir=output_dir,
                                      gt_file="../data_prepate/stage_2_train_labels_for_map.csv")
                maskRCNN.train()
