...
from core.test_engine import run_inference, run_inference_propo_result
...
def parse_args():
    ...
    parser.add_argument(
        '--prepro', dest='prepro', help='use pre calculated proposals', default = True)
...
if __name__ == '__main__':
    ...
    if args.dataset == "rsna2018":
        cfg.TEST.DATASETS = ('RSNA_2018_test',)
