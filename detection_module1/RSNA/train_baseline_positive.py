...
from mrcnn_original.config import Config
from mrcnn_original import utils
import mrcnn_original.model as modellib
from mrcnn_original import visualize
from mrcnn_original.model import log
...
# training dataset
anns = pd.read_csv(os.path.join(DATA_DIR, 'stage_1_train_labels_positive.csv')) #positive only
...
# Train
NUM_EPOCHS = 100 # train on positive samples only
import warnings
warnings.filterwarnings("ignore")
# use pretrained resnet50 weights
model_path = '../weights/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5'
